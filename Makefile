...
migrateup:
	migrate -path db/migration -database "postgresql://root:iwtMpKyEeOEWcLBE6OEl@simple-bank.cx4ycc42s4pt.us-east-1.rds.amazonaws.com:5432/simple_bank" -verbose up
migrateup1:
