...
// Source: github.com/parthmeh-cisco/simplebank/db/sqlc (interfaces: Store)
...
func (*MockStore) CreateUser(ctx context.Context, arg db.CreateUserParams) (db.User, error) {
	panic("unimplemented")
}
